...
ki2 = LINETCR.LINE()
ki2.login(token="Emq3XBoS52nByOHyPe1f.ReKXV+j5iqZ6yukPyRKWdW.gC7Mk3h3XIFdXx+UjS6MOEhiYPVMLqI6blDb4Pb/Uxg=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="EmxDHvNHAo0N0qTsFHq4.x8EQO61q9ouR7j6MuuDUza.xHq7iePBSp2/M76oS3YOX6CzKRQRzhlfGlfMqPuKhwQ=")
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token="EmIfejh0t8TkCBOqHpDc.+1CoOvv3xY3d23y2K6/G7a.KKmzMDJBNZ07kdTun8JWLRqX0Lbn6d749OOmEWBJ8+E=")
ki4.loginResult()

ki5 = LINETCR.LINE()
ki5.login(token="EmD4YyYLpvmw5yJHu4H1.2LI0lnW58S+mjMy04UkTmq.XOk1XIfZignoaTTOATlXc+eAFQJ/vrxDUvxbgH2PUCw=")
ki5.loginResult()

ki6 = LINETCR.LINE()
ki6.login(token="EmIpYj8EOStzrY8N3N95.v7TzPytl2t8MZO+8XbfxLq.gsBnQ2WdbMS9SNxUFqb7kom8B4qjRw37SDJLzGfl8nA=")
ki6.loginResult()

print "login success qal"
reload(sys)
sys.setdefaultencoding('utf-8')

helpMessage ="""      ༺R҉ u҉ q҉ a҉ l҉  в ҉o ҉т ҉༻\n✍T҉̶̘̟̼̉̈́͐͋͌̊Σ̶Δ̶M҉̶̘͈̺̪͓̺ͩ͂̾ͪ̀̋ ̶̶̶̶G̶̶H̶̶O̶̶U̶̶L̶β̶Ω̶T҉̶̘̟̼̉̈́͐͋͌̊✈
...
admin = "u885396f77de32a72849b6bb13bdeafed","u33e48395655b32cc74775e745211bfd5"
owner = "u885396f77de32a72849b6bb13bdeafed"
...
# ----------------- NOTIFED MEMBER JOIN GROUP
       ...
       #-----------------NOTIFED MEMBER JOIN GROUP
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
            if msg.from_ == "u885396f77de32a72849b6bb13bdeafed":
                    if "join:" in msg.text:
...
#--------------------------------------------------------
                ...
                if wait["autoJoin"] == True: md+="􀜁􀇔?? Auto Join:on 􀜁􀄯􏿿\n"
                ...
                msg.contentType = 13
                msg.contentMetadata = {'u885396f77de32a72849b6bb13bdeafed': admin}
...
#-----------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    try:
                        ...
                        pass
#-----------------------------------------------
            elif "Rb Key" in msg.text:
                ki.sendText(msg.to,"""      􀜁􀇔􏿿􀜁􀇔􏿿 RUQAL BOT [RB] 􀜁􀇔􏿿􀜁􀇔􏿿  \n\n 􀜁􀇔􏿿 key Only Kicker 􀜁􀇔􏿿 \n\n􀜁􀇔􏿿[Kb1 in]\n􀜁􀇔􏿿[1name:]\n􀜁􀇔􏿿[B Cancel]\n􀜁􀇔􏿿[kick @]\n􀜁􀇔􏿿[Ban @]\n􀜁􀇔􏿿[kill]\n􀜁􀇔􏿿[BotChat]\n􀜁􀇔􏿿[Respons]\n􀜁􀇔􏿿[Kb1 Gift]\n􀜁􀇔􏿿[Kb1 bye]\n\n   
  
        
  
☆ R̛̳̘ͬͤͮ͘̕͘u̷̖͛͂q̴̕a̧̟̖l̛̫͏͟ ͕̫̟̩́͛̒͞B̛̼̣̤̿͜͡ͅõ̭ͧ͑t̴͑͋͘͠͏


""")
                ki2.sendText(msg.to,"""     􀜁􀇔􏿿􀜁􀇔􏿿 RUQAL BOT [RB] ??􀇔􏿿􀜁􀇔􏿿  \n\n 􀜁􀇔􏿿 key Only Kicker 􀜁􀇔􏿿 \n\n􀜁􀇔􏿿[Kb2 in]\n􀜁􀇔􏿿[2name:]\n􀜁􀇔􏿿[B Cancel]\n􀜁􀇔􏿿[kick @]\n􀜁􀇔􏿿[Ban @]\n􀜁􀇔􏿿[kill]\n􀜁􀇔􏿿[BotChat]\n􀜁􀇔􏿿[Respons]\n􀜁􀇔􏿿[Kb2 Gift]\n􀜁􀇔􏿿[Kb2 bye]\n\n     
...
""")
                ki3.sendText(msg.to,"""     􀜁􀇔􏿿􀜁􀇔􏿿 RUQAL BOT [RB] 􀜁􀇔􏿿􀜁􀇔􏿿  \n\n 􀜁􀇔􏿿 key Only Kicker 􀜁􀇔􏿿 \n\n􀜁􀇔􏿿[Kb3 in]\n􀜁􀇔􏿿[3name:]\n??􀇔􏿿[B Cancel]\n􀜁􀇔􏿿[kick @]\n􀜁􀇔􏿿[Ban @]\n􀜁􀇔􏿿[kill]\n􀜁􀇔􏿿[BotChat]\n􀜁􀇔􏿿[Respons]\n􀜁􀇔��[Kb3 Gift]\n��􀇔􏿿[Kb3 bye]\n\n     
...
""")
                ki4.sendText(msg.to,"""     􀜁􀇔􏿿􀜁􀇔􏿿 RUQAL BOT [RB] 􀜁􀇔􏿿􀜁􀇔􏿿  \n\n 􀜁􀇔􏿿 key Only Kicker 􀜁􀇔􏿿 \n\n􀜁􀇔􏿿[Kb4 in]\n􀜁􀇔􏿿[4name:]\n􀜁􀇔􏿿[B Cancel]\n􀜁􀇔􏿿[kick @]\n􀜁􀇔􏿿[Ban @]\n􀜁􀇔􏿿[kill]\n􀜁􀇔􏿿[BotChat]\n􀜁􀇔􏿿[Respons]\n􀜁􀇔􏿿[Kb4 Gift]\n􀜁􀇔􏿿[Kb4 bye]\n\n     
...
""")
                ki5.sendText(msg.to,"""     􀜁􀇔􏿿􀜁􀇔􏿿 RUQAL BOT [RB] 􀜁􀇔􏿿􀜁􀇔􏿿  \n\n 􀜁􀇔􏿿 key Only Kicker 􀜁􀇔􏿿 \n\n􀜁􀇔􏿿[Kb5 in]\n􀜁􀇔􏿿[5name:]\n􀜁􀇔􏿿[B Cancel]\n􀜁􀇔􏿿[kick @]\n􀜁􀇔􏿿[Ban @]\n􀜁􀇔􏿿[kill]\n􀜁􀇔􏿿[BotChat]\n􀜁􀇔􏿿[Respons]\n􀜁􀇔􏿿[Kb5 Gift]\n􀜁􀇔􏿿[Kb5 bye]\n\n     
...
""")
                ki6.sendText(msg.to,"""     􀜁􀇔􏿿􀜁􀇔􏿿 RUQAL BOT [RB] 􀜁􀇔􏿿􀜁􀇔􏿿  \n\n 􀜁􀇔􏿿 key Only Kicker 􀜁􀇔􏿿 \n\n􀜁􀇔􏿿[Kb6 in]\n􀜁􀇔􏿿[6name:]\n􀜁􀇔􏿿[B Cancel]\n􀜁􀇔􏿿[kick @]\n􀜁􀇔􏿿[Ban @]\n􀜁􀇔􏿿[kill]\n􀜁􀇔􏿿[BotChat]\n􀜁􀇔􏿿[Respons]\n􀜁􀇔􏿿[Kb6 Gift]\n􀜁􀇔􏿿[Kb6 bye]\n\n     
...
#-----------------------------------------------
                ...
                for g in gs.members:
                    if _nametarget == g.displayName:
                       ...
                       ki2.sendText(g.mid,"Hallo")
                       ki3.sendText(g.mid,"Hallo")
                       ki4.sendText(g.mid,"Hallo")
                       ki5.sendText(g.mid,"Hallo")
                       ki6.sendText(g.mid,"Hallo")
                       cl.sendText(msg.to, "Done")
                       print " Spammed !"
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in admin:
                try:    
                    ...
                    ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Creator By \n\nhttp://line.me/ti/p/~fhrzxx")
                    print "Like"
                except:
                    pass
            else:
...
def autolike():
     for zx in range(0,50):
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
          try:    
	    cl.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
            cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by R̛̳̘ͬͤͮ͘̕͘u̷̖͛͂q̴̕a̧̟̖l̛̫͏͟ ͕̫̟̩́͛̒͞B̛̼̣̤̿͜͡ͅõ̭ͧ͑t̴͑͋͘͠͏\n\nhttp://line.me/ti/p/~mr.fhrza")
	    ki.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
            ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by R̛̳̘ͬͤͮ͘̕͘u̷̖͛͂q̴̕a̧̟̖l̛̫͏͟ ͕̫̟̩́͛̒͞B̛̼̣̤̿͜͡ͅõ̭ͧ͑t̴͑͋͘͠͏\n\nhttp://line.me/ti/p/~mr.fhrza")
	    ki2.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
            ki2.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by R̛̳̘ͬͤͮ͘̕͘u̷̖͛͂q̴̕a̧̟̖l̛̫͏͟ ͕̫̟̩́͛̒͞B̛̼̣̤̿͜͡ͅõ̭ͧ͑t̴͑͋͘͠͏\n\nhttp://line.me/ti/p/~mr.fhrza")
	    ki3.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
            ki3.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by R̛̳̘ͬͤͮ͘̕͘u̷̖͛͂q̴̕a̧̟̖l̛̫͏͟ ͕̫̟̩́͛̒͞B̛̼̣̤̿͜͡ͅõ̭ͧ͑t̴͑͋͘͠͏\n\nhttp://line.me/ti/p/~mr.fhrza")
	    ki4.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
            ki4.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by ✍R̛̳̘ͬͤͮ͘̕͘u̷̖͛͂q̴̕a̧̟̖l̛̫͏͟ ͕̫̟̩́͛̒͞B̛̼̣̤̿͜͡ͅõ̭ͧ͑t̴͑͋͘͠͏\n\nhttp://line.me/ti/p/~mr.fhrza")
	    ki5.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
            ki5.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by R̛̳̘ͬͤͮ͘̕͘u̷̖͛͂q̴̕a̧̟̖l̛̫͏͟ ͕̫̟̩́͛̒͞B̛̼̣̤̿͜͡ͅõ̭ͧ͑t̴͑͋͘͠͏\n\nhttp://line.me/ti/p/~mr.fhrza")
            print "Like"
          except:
            pass
        else:
